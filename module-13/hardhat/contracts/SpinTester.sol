...
/**
 * @title SpinTester
 * @dev Standalone contract for testing components of the spin flow without inheriting from CasinoSlot
 */
contract SpinTester is Ownable, VRFV2PlusWrapperConsumerBase {
    // External contracts
    ...
    uint256 public vrfCostLINK = 0.01 ether; // 0.01 LINK
    
    // Economic parameters
    uint256 public baseChipPriceUSD = 20; // $0.20 in cents
    ...
    // VRF callback function - called by the VRF Coordinator/Wrapper
