...
describe("ExchangeVisageToken", function () {
    ...
    describe("Withdrawal", function () {
        ...
        it("Should revert when receiver rejects ETH", async function () {
            ...
            const mockReceiver = await MockWithdrawReentrancyAttacker.deploy(await token.getAddress());
            ...
            await mockReceiver.acceptOwnership();
...
describe("ExchangeVisageNFT", function () {
    ...
    describe("Withdrawal", function () {
        ...
        it("Should handle failed withdrawals", async function () {
            ...
            const mockReceiver = await MockWithdrawReceiveAttacker.deploy(await nft.getAddress());
    ...
    it("Should prevent sending", async function () {
        const { nft, owner } = await loadFixture(deployFixture);
        // Fund the contract
