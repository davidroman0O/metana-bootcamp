...
describe("CommitRevealBitmap", function () {
  let nft;
  let owner;
  let addr1;
  let addr2;
  ...
  beforeEach(async function () {
    ...
    const NFT = await ethers.getContractFactory("CommitRevealBitmap");
  ...
  describe("Random Token ID Assignment", function () {
    ...
    it("Should measure gas usage for bitmap implementation", async function () {
      ...
      console.log(`Gas used for bitmap commit: ${commitGas}`);
