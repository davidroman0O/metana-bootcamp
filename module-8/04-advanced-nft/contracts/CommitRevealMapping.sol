...
contract CommitRevealMapping is ERC721Enumerable, Ownable, ReentrancyGuard, Multicall {
    ...
    function multicall(bytes[] calldata data) external override returns (bytes[] memory results) {
        ...
        // When copy pasting, I forgot the signature is different but if you come back to this... you know now
        bytes4 revealSelector = bytes4(keccak256("reveal(bytes32)"));  
